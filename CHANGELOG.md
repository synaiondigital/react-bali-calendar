...
### Fixed
- **Red text for national holidays** - Date number now displays in red for hari libur nasional (in addition to Sundays)

## [1.2.3] - 2025-12-19

### Added
- README documentation (English and Bahasa Indonesia)
- LICENSE file (MIT)
